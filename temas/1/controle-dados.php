	...
	$opendir=opendir($dir_atual);
	 ...
	 if(is_file($dir_atual."/".$nome_arquivo)==false){
		 ...
		 //abrimos o arquivo de configuração 
		  ...
		  //COR_LINK
		 $inicio = strpos($texto,"<COR_LINK>");
		 $fim     = strpos($texto, "</COR_LINK>", $inicio);
		 $vCor_link =substr($texto, $inicio, $fim - $inicio);
		 $vCor_link = str_replace("<COR_LINK>","",$vCor_link);	

		  //COR_LINKHOVER
		 $inicio = strpos($texto,"<COR_LINKHOVER>");
		 $fim     = strpos($texto, "</COR_LINKHOVER>", $inicio);
		 $vCor_linkhover =substr($texto, $inicio, $fim - $inicio);
		 $vCor_linkhover = str_replace("<COR_LINKHOVER>","",$vCor_linkhover);	
...
}elseif( $vAction == "carrega_REDESOCIAL"){
	...
	$opendir=opendir($dir_atual);
	 ...
	 if(is_file($dir_atual."/".$nome_arquivo)==false){
		 ...
		 $vCor_linkhover = str_replace("<COR_LINKHOVER>","",$vCor_linkhover);	
		  ...
		  //FORMATA AS REDES SOCIAIS
		$vRede = "";
		if( $vFacebook != "" ){
			
			$vRede .= "<a class='link' style='color:$vCor_link;' href='//www.facebook.com/$vFacebook' target='__blank'><i class='fab fa-facebook'></i></a> | ";
			
		}
		if( $vInstagram != "" ){
			
			$vRede .= " <a class='link' style='color:$vCor_link;' href='//www.instagram.com/$vInstagram' target='__blank' ><i class='fab fa-instagram'></i></a> | ";
			
		}
		if( $vTwitter != "" ){
			
			$vRede .= " <a class='link' style='color:$vCor_link;' href='//twitter.com/$vTwitter' target='__blank'><i class='fab fa-twitter'></i></a> | ";
			
		}
		if( $vLinkedin != "" ){
			
			$vRede .= "<a class='link' style='color:$vCor_link;' href='//www.linkedin.com/in/$vLinkedin' target='__blank'><i class='fab fa-linkedin'></i></a> | ";
			
		}
		if( $vYoutube != "" ){
			
			$vRede .= " <a class='link' style='color:$vCor_link;' href='//www.youtube.com/user/$vYoutube' target='__blank'><i class='fab fa-youtube'></i></a> | ";
			
		}
		$vRede = substr($vRede, 0, -2);
