...
*************************************************************************************************************/
					...
					for(campo in dados){
						...
						$.each(dados.CHECKS, function(index, value) {
							...
							if( cod_secao == 1 ){ $("#div_cabecalho").css("display","block");}
								...
								$("#menus").append("<li><a href='#produtos_servicos'> NOSSOS SERVICOS </a></li>");
	...
	function carrega_REDESOCIAL(arquivo_texto){
		
		$.get('controle-dados.php?action=carrega_REDESOCIAL&nome_arquivo='+arquivo_texto,
				function(data){
					
					$("#R_SOCIAL").html(data);
					$("#R_SOCIAL_RODAPE").html(data).css("font-size","0.9em");
...
***********************************************************************************************************/
	...
	function enviar_mensagem(){
		...
		if( origem == "" || assunto == "" || mensagem == ""){
						 ...
						 $("#mensagens_sys").html("<div class='alert alert-danger' role='alert'><center>"+atention+" </center></div>");
								...
								function(data){
									$("#mensagens_sys").html(data);
										...
										if (n > -1){
											...
											$("#mensagens_sys").html("<div class='alert alert-danger' role='alert'><center>"+data+"</center></div>");
											...
											$("#mensagens_sys").html("");
											$("#mensagens_sys").html("<div class='alert alert-success' role='alert'><center>"+data+" </center></div>");
